...
ЦЕНА И СПРОС: прежде чем предлагать изменение цены, проверь инструмент
elasticity — там видно, как спрос реально реагировал на прошлые изменения
...
_TOOL_RU = {"unit_economics": "юнитка", "stocks": "остатки", "pnl": "P&L",
            ...
            "money": "где деньги", "elasticity": "эластичность цены", "news": "новости площадок", "dashboard_catalog": "каталог API", "dashboard_api": "данные дашборда",
