...
def _parse_range(
    ...
    """Resolve explicit date strings or fall back to last N days."""
...
_DATE_FROM = Query(None, description="Date from (YYYY-MM-DD). Overrides ?days if set.")
_DATE_TO   = Query(None, description="Date to (YYYY-MM-DD). Defaults to today.")
_DAYS      = Query(30, ge=1, le=365, description="Lookback days (used when date_from not set).")
