...
def _is_banter(q: str, has_photo: bool) -> bool:
    ...
    if any(w in ql for w in banter_marks):
        return True
    # короткий ответ-согласие на предложение агента («прикинь», «давай», «го»)
    # — это продолжение работы, а не трёп; раньше уходило в шутку
    cont = ("прикинь", "прикини", "давай", "да", "ок", "окей", "окэй", "го",
            "посчитай", "покажи", "разбери", "разберись", "сделай", "проверь",
